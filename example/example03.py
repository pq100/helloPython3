...
elif cardno == 524353: result = '마스터카드 외한카드'
...
elif (daytime == 'midday') or (daytime == 'noon'): result = '점심시간 (12-13) '
if daytime == 'dawn' or (daytime == 'daybreak'): result = '저녁시간 (13-20) '
