...
kors.append(int(input('1번 학생 국어는? : ')))
engs.append(int(input('1번 학생 영어는? : ')))
maths.append(int(input('1번 학생 수학은? : ')))

names.append(input('2번 학생 이름은? : '))
kors.append(int(input('2번 학생 국어는? : ')))
engs.append(int(input('2번 학생 영어는? : ')))
maths.append(int(input('2번 학생 수학은? : ')))

names.append(input('3번 학생 이름은? : '))
kors.append(int(input('3번 학생 국어는? : ')))
engs.append(int(input('3번 학생 영어는? : ')))
maths.append(int(input('3번 학생 수학은? : ')))
